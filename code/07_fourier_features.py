# -*- coding: utf-8 -*-
"""
Created on Tue Apr 14 01:01:22 2026
...
# 2. Better input features
X_input = torch.cat([
    X / 1.5,
    torch.sin(10 * X), torch.cos(10 * X),
    torch.sin(30 * X), torch.cos(30 * X),
    torch.sin(70 * X), torch.cos(70 * X)
], dim=1)
...
# 4. Deeper model with 7 input features
class PerceptronDeeper(nn.Module):
    def __init__(self, hidden_size):
        super().__init__()
        self.hidden_layer_1 = nn.Linear(7, hidden_size)
